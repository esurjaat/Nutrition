...
The app can be found here: https://esurjaat.shinyapps.io/nutrition.  The current state of the app is loaded with sample data in order to showcase the project. In the near future, the app will be able to accommodate different users.
